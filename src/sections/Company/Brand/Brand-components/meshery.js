  ...
  return (
    <div className="post-content">
      ...
      >
        ...
        <SRLWrapper>
          <Row $Vcenter className="ImgDiv">
            ...
            <Col $xs={12} $sm={4}>
              <img
                src={MeshLogoLightTextSide}
                alt="MesheryLightTextSide Logo"
              />
            </Col>
          </Row>
          <Row $Vcenter className="ImgDiv">
      ...
      >
        ...
        <Col>
          <p>
            The Meshery color palette consists of the $primary Meshery color and
            additional shades. The Meshery logo should be white or monochrome
